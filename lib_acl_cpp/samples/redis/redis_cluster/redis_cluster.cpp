...
int main(int argc, char* argv[])
{
	...
	// µ±ƒ≥∏ˆ¡¨Ω”≥ÿΩ·µ„≥ˆŒ Ã‚£¨…Ë÷√ÃΩ≤‚∏√¡¨Ω”Ω·µ„ «∑Òª÷∏¥µƒ ±º‰º‰∏Ù(√Î)£¨µ±∏√÷µ
	// Œ™ 0  ±£¨‘Ú≤ªºÏ≤‚
	cluster.set_retry_inter(1);

<<<<<<< HEAD
	// …Ë÷√÷ÿ∂®œÚµƒ◊Ó¥Û∑ß÷µ£¨»Ù÷ÿ∂®œÚ¥Œ ˝≥¨π˝¥À∑ß÷µ‘Ú±®¥Ì
	cluster.set_redirect_max(nretry);

	// µ±÷ÿ∂®œÚ¥Œ ˝ >= 2  ±√ø¥Œ‘Ÿ÷ÿ∂®œÚ¥À∫Ø ˝…Ë÷√–›œ¢µƒ ±º‰(∫¡√Î)
=======
	// ËÆæÁΩÆÈáçÂÆöÂêëÁöÑÊúÄÂ§ßÈòÄÂÄºÔºåËã•ÈáçÂÆöÂêëÊ¨°Êï∞Ë∂ÖËøáÊ≠§ÈòÄÂÄºÂàôÊä•Èîô
	cluster.set_redirect_max(nretry);

	// ÂΩìÈáçÂÆöÂêëÊ¨°Êï∞ >= 2 Êó∂ÊØèÊ¨°ÂÜçÈáçÂÆöÂêëÊ≠§ÂáΩÊï∞ËÆæÁΩÆ‰ºëÊÅØÁöÑÊó∂Èó¥(ÊØ´Áßí)
